  ...
  return (
   <section id='features' className={`${layout.section}`}>
    <div className={`${layout.sectionInfo}`}>
      <h2 className={`${styles.heading2}`}>You do the <span className='text-gradient '>Business</span>,<br className='sm:block hidden'/> we'll handle the <span className='text-gradient '>Money</span></h2>
